...
function MessagesView ({ children }) {
  ...
  <div className="row collapse margin-top--2x margin-bottom--2x">
    <div className="medium-4 columns">
      <ul className="messages-tabs tabs vertical block-margins" id="example-vert-tabs" data-tabs="2dqsvw-tabs">
        <li role="presentation" className="messages-title tabs-title is-active">
          <a id="panel1v-label" aria-controls="panel1v" role="tab" href="#panel1v" aria-selected="true">
          <h3 classNameName="messages-from t-base">From: Ben Bills</h3>
          <p>Re: Gloria Luck</p>
          </a>
        </li>
        <li role="presentation" className="messages-title tabs-title">
          <a id="panel2v-label" aria-selected="false" aria-controls="panel2v" role="tab" href="#panel2v">
            <h3 className="messages-from t-base">From: Ben Bills</h3>
            <p>Re: Gloria Luck <span className="label small alert float-right">New</span></p>
          </a>
        </li>
      </ul>
    </div>
    <div className="medium-8 columns p-relative">
      <div className="message-content tabs-content vertical block-margins" data-tabs-content="example-vert-tabs">
        <div aria-labelledby="panel1v-label" aria-hidden="false" role="tabpanel" className="message-panel tabs-panel is-active" id="panel1v">
